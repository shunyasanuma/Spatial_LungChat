...
|:-------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------|
| plot_spatial                               | obj, annotation, title = NULL, point_size = 0.5, base_size = 12, coord_flip = FALSE, highlight = NULL                                             | Generate spatial scatterplot using any coordinate system found in colData() |
| plot_umap                                  | obj, platform = c('Visium', 'Xenium'), annotation = 'Final_CT', title = NULL, point_size = 0.5, legend_point_size = 4, highlight = NULL           | Platform-specific UMAP plot for a given annotation                          |
| plot_gene_spatial                          | obj, gene, platform = c('Visium', 'Xenium'), x_col = NULL, y_col = NULL, title = NULL, point_size = 0.5, low_color = 'grey90', high_color = 'red' | Visualize gene expression spatially for a given gene and platform           |
| rank_cross_platform_gene_correlation       | obj, top_genes = 5, layer = 'X'                                                                                                                   | Return top cross-platform correlated genes from expression matrix           |
| plot_cross_platform_gene_correlation       | obj, gene_name, ID1_col = 'Visium_ID', ID2_col = 'Xenium_ID', hline = 0.9, y_range = c(0, 1), title = NULL                                        | Cumulative correlation plot for a given gene across matched spot pairs      |
| scTriangulate_summarize_celltype_stability | sce, celltype_labels, show_all_metrics = FALSE                                                                                                    | Summarize Shapley and other metrics for selected clusters across platforms  |
| rank_marker_specificity                    | sce, gene_name = 'COL1A1', cluster_cols = c('pruned'), assay_name = 'X', platforms = c('Xenium', 'Visium'), top_n = NULL                          | Compute t-test based enrichment and specificity of a gene for each cluster  |
| find_top_markers_for_celltype              | obj, celltype, annotation_col, platform_suffixes, top_n = 10                                                                                      | Identify top markers for a specific cell type using t-test and logFC        |
| plot_ARI_dotplot                           | obj, annotation1, annotation2, title = NULL, size_range = c(1, 10)                                                                                | Dotplot showing overlap of two annotations with ARI score                   |
| plot_marker_expression_dotplot             | obj, genes, platforms = c('visium', 'xenium'), annotation = 'pruned', assay_name = 'X', min_pct = 0.05, max_genes = 50, rotate_x = TRUE           | Dotplot of selected gene expressions across clusters and platforms          |
| plot_cluster_composition_groupedbar        | obj, annotation, palette = NULL, title = NULL, rotate_x = TRUE                                                                                    | Barplot comparing cluster compositions across one or two annotations        |
| compare_annotations_via_heatmap            | obj, annotation1, annotation2, normalize = c('none', 'row', 'column', 'both'), palette = 'Blues', title = NULL                                    | Generate a heatmap comparing two annotations with normalization options     |
| visualize_matched_pairs_scatter            | obj, gene, layer = 'X', log1p = TRUE, point_size = 0.4, alpha = 0.6, show_correlation = FALSE, title = NULL                                       | Scatterplot of gene expression in matched Visium and Xenium spots           |
| generate_stability_report                  | sce, celltype_labels                                                                                                                              | Returns barplot and table of cluster stability metrics per annotation       |
| generate_marker_report                     | sce, genes, annotation_cols, assay_name = 'X', min_pct = 5, max_genes_plot = 50                                                                   | Returns dotplot and table of marker gene enrichment across annotations      |
| find_celltype_markers                      | sce, celltype, annotation_col, platform = 'Xenium', assay_name = 'X', top_n = 10, logfc_threshold = 0.25, padj_threshold = 0.05                   | Returns volcano plot and table of DE genes for a given celltype             |
